...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-[#EBE6DD]">
      ...
      {/* Features Section */}
      <section id="how-it-works" className="px-6 py-24 lg:px-16 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl lg:text-6xl font-bold text-center mb-16 text-balance">
            Как это <span className="text-[#FF5C00]">работает</span>
          </h2>

          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-[#EBE6DD] rounded-3xl p-8 space-y-4">
              <div className="w-16 h-16 bg-[#FF5C00] rounded-2xl flex items-center justify-center text-white text-2xl font-bold">
                1
              </div>
              <h3 className="text-2xl font-bold">Выбери кофейню</h3>
              <p className="text-gray-700 leading-relaxed">Найди ближайшую кофейню на карте или выбери любимое место</p>
            </div>
            ...
            <div className="bg-[#EBE6DD] rounded-3xl p-8 space-y-4">
              ...
              <h3 className="text-2xl font-bold">Сделай заказ</h3>
              <p className="text-gray-700 leading-relaxed">Выбери напиток из меню и оплати онлайн за пару секунд</p>
            </div>
            ...
            <div className="bg-[#EBE6DD] rounded-3xl p-8 space-y-4">
              ...
              <h3 className="text-2xl font-bold">Забери кофе</h3>
      ...
      <section id="what-is" className="px-6 py-24 lg:px-16 bg-[#EBE6DD]">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl lg:text-6xl font-bold text-center mb-12 text-balance">
          ...
          <div className="bg-white rounded-3xl p-8 lg:p-12 mb-8">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-8">
              <div className="flex flex-col items-center text-center">
                <div className="w-20 h-20 bg-[#FF5C00] rounded-full flex items-center justify-center mb-4">
                  <span className="text-3xl">👤</span>
                </div>
                <p className="font-semibold">Клиент</p>
              </div>

              <div className="hidden md:block text-[#FF5C00] text-3xl">→</div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="font-semibold">Бариста</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p className="font-semibold">Выдача кофе</p>
              </div>
            </div>

            <div className="text-center">
              <p className="text-xl lg:text-2xl font-bold mb-6 text-balance">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-3xl p-8">
              <h3 className="text-xl font-bold mb-4">Для клиентов</h3>
              <p className="text-gray-700 leading-relaxed">
                Клиент заказывает заранее, оплачивает онлайн и просто забирает готовый напиток.
              </p>
            </div>
            <div className="bg-white rounded-3xl p-8">
              <h3 className="text-xl font-bold mb-4">Для кофеен</h3>
              <p className="text-gray-700 leading-relaxed">Вы — получаете оплату, статистику и новых клиентов.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="for-coffee-shops" className="px-6 py-24 lg:px-16 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl lg:text-6xl font-bold text-center mb-4 text-balance">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {/* Card 1 */}
            <div className="bg-[#EBE6DD] rounded-3xl p-8 space-y-4">
              <div className="w-16 h-16 bg-[#FF5C00] rounded-2xl flex items-center justify-center">
                <DollarSign className="h-8 w-8 text-white" />
              </div>
              <h3 className="text-2xl font-bold">0₸ до 1 января</h3>
              <p className="text-gray-700 leading-relaxed">Бесплатное подключение</p>
            </div>
            ...
            <div className="bg-[#EBE6DD] rounded-3xl p-8 space-y-4">
              ...
              <h3 className="text-2xl font-bold">+20% заказов</h3>
              <p className="text-gray-700 leading-relaxed">Клиенты TapDrink приходят сами</p>
            </div>
            ...
            <div className="bg-[#EBE6DD] rounded-3xl p-8 space-y-4">
              ...
              <h3 className="text-2xl font-bold">Без интеграций</h3>
              <p className="text-gray-700 leading-relaxed">Всё работает через обычный смартфон</p>
            </div>
            ...
            <div className="bg-[#EBE6DD] rounded-3xl p-8 space-y-4">
              ...
              <h3 className="text-2xl font-bold">Мгновенные заказы</h3>
              <p className="text-gray-700 leading-relaxed">Заказы поступают в реальном времени</p>
            </div>
            ...
            <div className="bg-[#EBE6DD] rounded-3xl p-8 space-y-4">
              ...
              <h3 className="text-2xl font-bold">Прозрачная комиссия 13%</h3>
              <p className="text-gray-700 leading-relaxed">Никаких скрытых платежей</p>
            </div>
            ...
            <div className="bg-[#EBE6DD] rounded-3xl p-8 space-y-4">
              ...
              <h3 className="text-2xl font-bold">Поддержка от реальных бариста</h3>
              <p className="text-gray-700 leading-relaxed">Мы понимаем ваш бизнес</p>
            </div>
          </div>

          <div className="text-center">
            <p className="text-xl lg:text-2xl text-gray-700 max-w-4xl mx-auto text-balance">
      ...
      <section className="px-6 py-24 lg:px-16 bg-[#EBE6DD]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-3xl p-8 space-y-6">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-3">Оставляете заявку</h3>
                <p className="text-gray-700 leading-relaxed">Мы связываемся и подключаем кофейню.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 space-y-6">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-3">Подписывайте договор и подключаетесь</h3>
                <p className="text-gray-700 leading-relaxed">Клиенты видят вас в приложении и начинают заказывать.</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 space-y-6">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-3">Продаёте больше без очередей</h3>
                <p className="text-gray-700 leading-relaxed">Все заказы и отчёты — в одном интерфейсе.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="px-6 py-24 lg:px-16 bg-gradient-to-br from-[#cfa173] to-[#6c4e2f] text-white relative overflow-hidden">
        <div className="max-w-5xl mx-auto text-center space-y-8 relative z-10">
          <h2 className="text-4xl lg:text-6xl font-bold text-balance">Бесплатное подключение до 1 января</h2>

          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-6 sm:p-8 lg:p-12 space-y-6 lg:space-y-8">
            ...
            <ul className="text-left max-w-2xl mx-auto space-y-3 sm:space-y-4 text-base sm:text-lg lg:text-xl">
            ...
            <div className="pt-2">
              <a href="#application">
                <Button
                  size="lg"
                  className="rounded-2xl bg-white text-[#6c4e2f] hover:bg-gray-100 px-6 sm:px-8 lg:px-10 py-4 sm:py-5 lg:py-6 text-base sm:text-lg lg:text-xl font-bold shadow-2xl w-full sm:w-auto"
                >
      ...
      <section id="app" className="px-6 py-24 lg:px-16 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-6xl font-bold mb-6 text-balance">
              Приложение <span className="text-[#FF5C00]">изнутри</span>
            </h2>
            <p className="text-2xl lg:text-3xl text-gray-600 font-light">Интуитивно. Просто. Современно.</p>
          </div>

          {/* App Screenshots Carousel */}
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Screenshot 1 - Main Screen */}
            <div className="bg-[#EBE6DD] rounded-3xl p-6 space-y-4">
              ...
              <p className="text-center font-semibold">Главный экран с кофейнями</p>
            </div>
            ...
            <div className="bg-[#EBE6DD] rounded-3xl p-6 space-y-4">
              ...
              <p className="text-center font-semibold">Карточка заказа</p>
            </div>
            ...
            <div className="bg-[#EBE6DD] rounded-3xl p-6 space-y-4">
              ...
              <p className="text-center font-semibold">Экран оплаты</p>
            </div>
            ...
            <div className="bg-[#EBE6DD] rounded-3xl p-6 space-y-4">
              ...
              <p className="text-center font-semibold">Экран кофейни (админка)</p>
            </div>
          </div>
      ...
      <section id="application" className="px-6 py-24 lg:px-16 bg-[#EBE6DD]">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl lg:text-6xl font-bold mb-6 text-balance">
              Оставьте <span className="text-[#FF5C00]">заявку</span>
            </h2>
            <p className="text-lg text-gray-600">Мы свяжемся в течение 24 часов и покажем, как TapDrink работает.</p>
          </div>
      ...
      {/* Contacts Section */}
      <section id="contacts" className="px-6 py-24 lg:px-16 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl lg:text-6xl font-bold text-center mb-16 text-balance">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-[#EBE6DD] rounded-3xl p-8 space-y-6">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-[#FF5C00] rounded-xl flex items-center justify-center flex-shrink-0">
                  <MapPin className="h-6 w-6 text-white" />
                </div>
                <div>
                  <h3 className="font-bold text-xl mb-2">Адрес</h3>
                  <p className="text-gray-700">Алматы, Казахстан</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+7XXXXXXXXXX" className="text-gray-700 hover:text-[#FF5C00] transition-colors">
                    +7 XXX XXX XX XX
                  </a>
                </div>
              </div>
            ...
            <div className="bg-[#EBE6DD] rounded-3xl p-8 space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:hello@tapdrink.app" className="text-gray-700 hover:text-[#FF5C00] transition-colors">
                    hello@tapdrink.app
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-xl mb-2">Социальные сети</h3>
      ...
      {/* FAQ Section */}
      <section id="faq" className="px-6 py-24 lg:px-16 bg-[#EBE6DD]">
          ...
          <div className="space-y-4">
            <details className="bg-white rounded-2xl p-6 group">
              <summary className="font-bold text-lg cursor-pointer list-none flex items-center justify-between">
                ...
                <span className="text-[#FF5C00] text-2xl group-open:rotate-45 transition-transform">+</span>
              </summary>
      ...
      {/* CTA Section */}
      <section id="app" className="px-6 py-24 lg:px-16 bg-[#FF5C00] text-white">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="text-4xl lg:text-6xl font-bold text-balance">Начни экономить время уже сегодня</h2>
          <p className="text-xl leading-relaxed opacity-90">Скачай приложение и получи первый кофе со скидкой 50%</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              asChild
              size="lg"
              className="rounded-full bg-white text-[#FF5C00] hover:bg-gray-100 px-8 py-6 text-lg font-semibold cursor-pointer"
            >
      ...
      {/* Footer */}
      <footer className="px-6 py-12 lg:px-16 bg-[#1A1A1A] text-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="text-[#FF5C00] font-bold text-2xl mb-4">
                Tap
                <br />
                Drink
              </div>
              <p className="text-gray-400 text-sm">Кофе на вынос без очередей</p>
            </div>
